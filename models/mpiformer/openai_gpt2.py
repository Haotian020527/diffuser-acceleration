...
class GPT2DoubleHeadsModelOutput(ModelOutput):
    ...
    Args:
        ...
        past_key_values (:obj:`List[torch.FloatTensor]`, `optional`, returned when ``use_cache=True`` is passed or when ``config.use_cache=True``):
            ...
            batch_size, n_heads, sequence_length, embed_size_per_head)`).
        ...
        attentions (:obj:`tuple(torch.FloatTensor)`, `optional`, returned when ``output_attentions=True`` is passed or when ``config.output_attentions=True``):
            Tuple of :obj:`torch.FloatTensor` (one for each layer) of shape :obj:`(batch_size, n_heads,
...
GPT2_INPUTS_DOCSTRING = r"""
    Args:
        ...
        head_mask (:obj:`torch.FloatTensor` of shape :obj:`(n_heads,)` or :obj:`(n_layers, n_heads)`, `optional`):
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def set_layers(self, n_layers):
        assert 1 <= n_layers <= len(self.h)
        if n_layers is not None:
            n_layers -= 1
        self.use_layers = n_layers
    ...
    def forward(
        ...
        if attention_mask is not None:
            ...
            # So we can broadcast to [batch_size, n_heads, from_seq_length, to_seq_length]
        ...
        presents = () if use_cache else None # training: ()
        all_self_attentions = () if output_attentions else None # None
        all_cross_attentions = () if output_attentions and self.config.add_cross_attention else None # None
